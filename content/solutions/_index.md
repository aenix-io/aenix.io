...
- **[DORA compliance](/solutions/dora-compliance/)** — Cloud architecture aligned with DORA Articles 21, 23, 24, 28. For financial entities and ICT third-party providers in scope. Pairs with: Private Cloud Platform. Free [DORA checklist](/resources/dora-compliance-checklist/).
- **[NIS2 compliance](/solutions/nis2-compliance/)** — NIS2-aligned multi-tenant cloud platform for essential and important entities. Pairs with: Private Cloud Platform. Free [NIS2 checklist](/resources/nis2-compliance-checklist/).
- **[Data sovereignty](/solutions/data-sovereignty/)** — Customer-controlled keys, customer-controlled hardware, jurisdictional data residency. Pairs with: Private Cloud Platform or Public Cloud Platform.
...
- **[Hybrid cloud platform](/solutions/hybrid-cloud-platform/)** — Single Ænix Platform spanning on-prem + cloud. Pairs with: Private Cloud Platform or Public Cloud Platform.
