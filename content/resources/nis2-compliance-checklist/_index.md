...
quick_facts:
  ...
  - label: "Pairs with"
    value: "Ænix Platform Enterprise Edition, NIS2-aligned by design (Cilium segmentation, customer-controlled encryption, audit-ready logging)."
  - label: "License"
...
faq:
  ...
  - q: "How does Aenix help with NIS2 compliance?"
    a: "Aenix uses this checklist during NIS2-aligned readiness engagements and offers NIS2 compliance services for deeper work. Its Ænix Platform Enterprise Edition, built on the CNCF project Cozystack, supports relevant controls through Tenant CRD segmentation with Cilium NetworkPolicy, customer-controlled encryption, and audit-ready logging."
...
> **Pairs with:** **[Ænix Platform Enterprise Edition](/products/private-cloud-platform/)** — NIS2-aligned by design (Tenant CRD with NetworkPolicy / Cilium for segmentation, customer-controlled encryption, audit-ready logging, coordinated vulnerability disclosure aligned with Article 30).
