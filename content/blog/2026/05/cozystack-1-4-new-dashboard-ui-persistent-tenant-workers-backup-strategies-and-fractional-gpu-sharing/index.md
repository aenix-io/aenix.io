...
Deploying a managed Kubernetes cluster uses the same schema-driven form, with cluster addons exposed declaratively.

A managed HTTP cache deployment, with PVC sizing, storage class, endpoints, and resource parameters all generated from the application schema.
...
[Cozystack 1.4: New Dashboard UI, Persistent Tenant Workers, Backup Strategies, and Fractional GPU Sharing](https://blog.aenix.io/cozystack-1-4-0c5e399a7308) was originally published in [Ænix](https://blog.aenix.io) on Medium, where people are continuing the conversation by highlighting and responding to this story.
