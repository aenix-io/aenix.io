...
quiz:
  ...
  questions:
    - q: "How many mandatory areas does NIS2 Article 21 require measures across?"
      options:
        - { text: "5 (the original NIS1 core security domains)", correct: false }
        - { text: "15 (Annex II extended technical control set)", correct: false }
        - { text: "10 (risk, incidents, BC, supply chain, crypto, MFA, etc.)", correct: true }
    ...
    - q: "What is the deadline structure for NIS2 incident reporting (Article 23)?"
      options:
        - { text: "24h early warning + 72h notification + 1-month final report", correct: true }
        - { text: "One consolidated annual summary report to the CSIRT", correct: false }
        - { text: "Single 7-day notification window (no staged reports)", correct: false }
    ...
    - q: "When was the NIS2 transposition deadline?"
      options:
        ...
        - { text: "17 October 2024 (national transposition into law)", correct: true }
        - { text: "1 January 2026 (full enforcement and audit start date)", correct: false }
    ...
    - q: "What does the article recommend for actually walking through the checklist?"
      options:
        - { text: "Compliance team alone (own the checklist end-to-end internally)", correct: false }
        - { text: "Hand it to vendor or auditor for external desk review", correct: false }
