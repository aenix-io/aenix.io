  ...
  questions:
    - q: "How many parallel workstreams structure the Aenix 14-day assessment?"
      options:
        ...
        - { text: "Six parallel workstreams", correct: false }
        - { text: "Eight parallel workstreams", correct: false }
    ...
    - q: "What share of public-cloud spend does the assessment typically find structurally repatriable in 6–12 months without performance regression?"
      options:
        - { text: "Five to ten percent of spend", correct: false }
        - { text: "Eighty to one hundred percent of spend", correct: false }
        - { text: "Fifteen to thirty-five percent of spend", correct: true }
        - { text: "Fifty to seventy percent of spend", correct: false }
    ...
    - q: "On the 14-day calendar, what happens on Day 10?"
      options:
        - { text: "Findings checkpoint with the customer", correct: true }
        - { text: "Final executive readout to stakeholders", correct: false }
    ...
    - q: "According to the article, why does Aenix push back on pre-decided answers at Day 0?"
      options:
        ...
        - { text: "It triggers regulatory non-compliance findings", correct: false }
    ...
    - q: "Which of these is named as a STRONG fit for starting the assessment?"
      options:
        - { text: "A regulator deadline driving urgency", correct: true }
        - { text: "A five-person IT team running one or two systems", correct: false }
        - { text: "A freshly signed multi-year hyperscaler commitment", correct: false }
