...
quick_facts:
  ...
  - label: "Engagement modes"
    value: "Architecture review (5-10 days), implementation engagement (1-6 months), or managed engagement."
  - label: "Scope covered"
    value: "Cloud architecture, infrastructure-as-code (Terraform, OpenTofu, Pulumi, Crossplane), observability (VictoriaMetrics, Grafana, OpenTelemetry), CI/CD and GitOps, Kubernetes, network and identity, FinOps, and compliance posture."
...
- Infrastructure-as-code maturity (Terraform, OpenTofu, Pulumi, Crossplane)
- Observability stack engineering (VictoriaMetrics, Grafana, OpenTelemetry)
- CI/CD and GitOps maturity
- Container orchestration (Kubernetes platform decisions)
- Network and identity engineering
- FinOps integration
- Compliance posture (DORA, NIS2, sectoral)
