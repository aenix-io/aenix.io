...
Public Cloud Platform entry from $1,250 per month (Basic support tier, 10 nodes). Other editions: pricing on request via discovery call. Engagement add-ons (assessment, pilot, build, managed ops) priced separately per scope. [Pricing details →](/pricing/).
