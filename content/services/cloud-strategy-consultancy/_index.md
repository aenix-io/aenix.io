...
quick_facts:
  ...
  - label: "Who it's for"
    value: "CIOs, CTOs, VP Engineering and platform leaders deciding workload placement, hybrid architecture, or repatriation from hyperscalers."
  - label: "Delivered by"
...
## How we differ from Big-4 cloud strategy

- **Engineers, not analysts** — same engineers who build production platforms
- **No hyperscaler partnership** — no commercial bias on recommendation
- **Open-source destination preferred** — when economics support it
