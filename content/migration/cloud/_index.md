...
> **Pairs with:** any **[Ænix Platform Edition](/products/)** — the destination depends on the buyer profile and migration pattern. Hosting providers exiting a shared cloud stack land on the Public Cloud Platform; regulated enterprises on the Private Cloud Platform; large operators on the Public Cloud Platform; product-engineering teams on the Developer Self-Service; AI-heavy estates on the AI Platform.
