...
хранилище. Журналы собирает **fluent-bit** — та же роль, только для текста.

**Alerta** сводит срабатывания правил в одно место, чтобы одна авария не приходила восемью
письмами из восьми источников.
