...
**Talos Linux** — операционная система узлов. Её особенность в том, что у неё нет
...
Отсюда практическое следствие, которое любят выносить в вопросы: чтобы понять, встала ли
платформа, смотрят не на поды, а на релизы Flux:
...
| `distro` | Kubernetes-дистрибутив: кластеры для арендаторов |
...
управляющему слою. Для виртуализации нужна вложенная виртуализация и проброс возможностей
процессора.
...
<li>Названия четырёх вариантов установки — дословно.</li>
