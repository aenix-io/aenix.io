...
description: "Cloud-Kosten steigen, Lock-in wächst, Souveränität wird Kundenanforderung. Repatriieren oder auf offener Plattform bauen — schlüsselfertig oder mit Aenix als Team."
type: "page"
language: "de"
...
Engineering in der EU · Apache 2.0 · Auf Ihrer Hardware · Kein Hyperscaler-Lock-in
</div>
...
**Müssen wir alles repatriieren?**
Nein. Selektiv: verlagern, wo Kosten oder Souveränität es rechtfertigen, den Rest behalten. Das Projekt klärt, was was ist.

**Wie belegen wir die Ersparnis vorab?**
...
**Welcher Lock-in bei euch?**
Apache 2.0 und Ihre Infrastruktur. Support und Projekte sind Services, keine fesselnde Lizenz.
...
LinkedIn DACH: CTO, VP Engineering, Chefarchitekt, VP Technologie (Scale-up / SaaS / Produkt).
