...
quick_facts:
  - label: "Was es ist"
    value: "Aufbau, Betrieb oder Beschleunigung einer internen Entwickler-Plattform (IDP) für mehrere Produkt-Teams durch das Team hinter Cozystack"
  - label: "Lizenz"
    value: "Apache 2.0 (keine CPU-/Core-basierte Lizenzierung)"
  - label: "Status"
    value: "Cozystack ist ein CNCF-Projekt (Sandbox seit 28.02.2025; Incubating erwartet Spätsommer 2026)"
  - label: "Zielgruppe"
    value: "Engineering-Organisationen mit mehreren Produkt-Teams, überlasteter DevOps/SRE-Funktion oder Compliance-, Souveränitäts- und Kostendruck"
  - label: "Engagement-Modi"
    value: "Platform Readiness Assessment (14-28 Tage), Build-Engagement (3-12 Monate), Managed-Engagement (Betrieb unter Vertrag)"
...
faq:
  ...
  - q: "Müssen wir Cozystack nutzen, um mit Aenix zu arbeiten?"
    a: "Aenix ist das Team hinter Cozystack und baut Plattformen darauf auf — einem CNCF-Sandbox-Projekt unter Apache 2.0. Cozystack vereint VMs und Container, Networking und Storage über eine Kubernetes-API. Ohne CPU-/Core-Lizenzierung vermeiden Sie Vendor-Lock-in proprietärer Plattformen."
  - q: "Welche Engagement-Modi bietet Aenix an?"
    a: "Drei Modi: Platform Readiness Assessment (14-28 Tage, schriftliche Bewertung plus Phase-2-Plan), Build-Engagement (3-12 Monate, Aenix-Engineers arbeiten in Ihrem Team), und Managed-Engagement, in dem Aenix die Plattform unter Vertrag betreibt."
  - q: "Wann ist Platform Engineering für uns sinnvoll?"
...
Produktionsreifes Plattform-Team · Apache-2.0-Foundation · Engineers, keine Architekten · EU + Zentralasien
</div>
...
- **Eine Plattform-Entscheidung auf Vorstandsebene** steht an — Repatriation, Konsolidierung, Vendor-Auswahl.

Wenn drei oder mehr zutreffen, ist strukturiertes Platform Engineering der Hebel. Hat Ihre Organisation ein einzelnes 10-Personen-Dev-Team und einen Satz Services, ist eine schlankere DevOps-Praxis kosteneffizienter.
...
**1. Interne Entwickler-Plattform mit Golden Paths**
Self-Service-Pfade für die 5-10 häufigsten Produkt-Team-Bedürfnisse (Environment-Provisioning, Application-Deployment, Observability-Onboarding, Secrets, Identity). Gebaut auf Kubernetes mit GitOps, IaC und einem operativen Modell, das Ihr Team tragen kann.

**2. Multi-Tenant-Plattform-Foundation**
Tenant-CRD-Modell, per-Tenant-Quotas, RBAC, Observability-Scope und Audit-Trails. Geeignet für Service Provider, die externe Kunden bedienen, oder Enterprise-Plattformen, die interne Business-Units bedienen.

**3. Operatives Modell und Runbooks**
...
**Das Plattform-Team baut für sich, nicht für die Produkt-Teams**
...
| Wann | Was | Ergebnis |
|---|---|---|
| **Tag 0** | 30-min Discovery-Call (kostenlos) | Fit bestätigen, Scope und Stage identifizieren |
| **Phase 1: Assessment (14-28 Tage)** | Platform Readiness Assessment | Schriftliche Bewertung, Ziel-Architektur, Phase-2-Roadmap |
| **Phase 2: Build (3-12 Monate)** | Plattform-Foundation, Golden Paths, Runbooks, Knowledge-Transfer | Produktionsreife interne Entwickler-Plattform |
| **Phase 3: Betrieb (laufend)** | Optionale Managed-Services-Vereinbarung oder vollständiger In-house-Betrieb | Plattform, die Engineer-Fluktuation überlebt |
...
Folgt Phase 2 auf das Assessment, werden die Assessment-Kosten je nach Scope gegen das Implementations-Engagement angerechnet.

Wir akzeptieren RFI / RFP über Standard-Beschaffungskanäle.
...
**Weitere Fragen?** Siehe den **[Platform Engineering vs DevOps Leitfaden](/de/blog/2026/05/platform-engineering-vs-devops-vs-sre/)** oder **[sprechen Sie mit uns](#discovery)**.
...
Oder lesen Sie mehr:
- **[Platform Engineering vs DevOps vs SRE](/de/blog/2026/05/platform-engineering-vs-devops-vs-sre/)** — Terminologie und Team-Struktur
- **[Internal Developer Platform](/de/dienstleistungen/internal-developer-platform/)** — IDP-spezifisches Engagement
- **[Kubernetes Consulting](/de/dienstleistungen/kubernetes-consulting/)** — für engeren Scope
- **[Platform Readiness Assessment](/de/dienstleistungen/platform-readiness-assessment/)** — Assessment-Methodologie
- **[Cozystack](/de/produkte/cozystack/)** — die Plattform, auf der wir typischerweise bauen
