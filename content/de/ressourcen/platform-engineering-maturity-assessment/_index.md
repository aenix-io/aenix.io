---
title: "Platform Engineering Maturity Assessment — bewerten Sie Ihre Organisation (kostenloses PDF)"
description: "Eine 8-Dimensionen-Selbsteinschätzung, die Ihre Platform-Engineering-Praxis auf einer 5-Stufen-Reife-Skala bewertet. Kostenloses PDF, verwendet von Aenix."
type: "page"
related_pages:
  - /de/dienstleistungen/platform-engineering
  - /de/dienstleistungen/internal-developer-platform
  - /de/produkte/private-cloud-platform/
hreflang_en: /resources/platform-engineering-maturity-assessment/
language: "de"
...
quick_facts:
  ...
  - label: "Empfohlener nächster Schritt"
    value: "Die Developer-Self-Service-Ebene der Ænix Private Cloud Platform (GitLab, Argo CD, APIs, Golden Paths) auf der Cozystack-Cloud-Foundation"
  - label: "Lizenz"
...
faq:
  ...
  - q: "Was wird nach dem Assessment empfohlen?"
    a: "Die meisten Ergebnisse verweisen auf die Developer-Self-Service-Ebene der Ænix Private Cloud Platform als strukturierten nächsten Schritt — den Internal-Developer-Platform-Layer (GitLab, Argo CD, APIs, Golden Paths) auf der Cozystack-Cloud-Foundation mit KubeVirt für VMs und Container, Cilium-Networking und LINSTOR-Storage."
...
{{< pipedrive-form type="lead-magnet" resource="platform-engineering-maturity-assessment" >}}
<p class="lead-magnet-form__note">Maturity Assessment herunterladen (PDF)</p>
</div>

---

## Was bewertet wird (8 Dimensionen)

1. **Workload-Portabilität** — IaC-Coverage, Drift-Detection, Environment-Parität
2. **GitOps-Adoption** — deklarative Ops, PR-driven Changes, Audit-Trail
3. **Observability-Vereinheitlichung** — Single Pane of Glass, SLO-Disziplin, Alert-Hygiene
4. **Secrets-Handhabung** — zentrales Management, Rotation, Audit
5. **Identity-Modell** — Workforce ↔ Workload Identity-Federation
6. **Multi-Tenancy** — Namespace-, Project- oder Tenant-CRD-Modell
7. **Disaster-Recovery-Reifegrad** — Backup, Restore, DR-getestete Kadenz
8. **Self-Service-Tiefe** — Golden Paths, Time-to-Environment

Für jede Dimension dieselbe 5-Stufen-Rubrik: Pre-platform → Shared infrastructure → Self-service primitives → Internal Developer Platform → Mature.

<div class="arch-section__fig">
<div class="diagram">
<div class="diagram__node"><b>8-Dimensionen-Selbsteinschätzung</b><div class="diagram__chips"><span>5-Stufen-Reife-Skala</span><span>Kostenloses PDF</span></div></div>
...
<div class="diagram__node diagram__node--brand"><b>Ænix Private Cloud Platform — Developer-Self-Service-Ebene</b><div class="diagram__chips"><span>GitLab</span><span>Argo CD</span><span>Golden Paths</span></div></div>
</div>
</div>
