...
quick_facts:
  ...
  - label: "Engagement"
    value: "Ænix Platform Provider Edition ab 1.250 USD/Monat Support-Tier; Partner-Programm mit bis zu 40% Marge"
  - label: "Status"
...
faq:
  ...
  - q: "Lässt sich die Plattform in mein bestehendes Billing integrieren?"
    a: "Ja. Die Ænix Platform Provider Edition bietet eine WHMCS-Integration in zwei Modi sowie Tenant Lock/Suspension. So lassen sich Provisionierung, Abrechnung und Sperrung säumiger Kunden direkt an die Mandanten-Isolation über das Tenant-CRD koppeln."
  - q: "Wie funktioniert die Migration von VMware, OpenStack oder Virtuozzo?"
    a: "Die Provider Edition enthält produktisiertes Migrations-Tooling für Workloads von VMware, OpenStack und Virtuozzo. KubeVirt führt migrierte VMs und neue Container über dieselbe Kubernetes-API aus, sodass kein paralleler Betrieb zweier Stacks nötig ist."
  ...
  - q: "Was kostet die Ænix Platform Provider Edition?"
  ...
  - q: "Worin unterscheidet sich die Plattform von OpenStack für Hosting-Anbieter?"
    a: "Die Provider Edition positioniert sich als moderne Alternative zu OpenStack: produktisierter Installer, schnellere Feature-Bereitstellung, WHMCS-integriertes Billing und ein Service-Katalog jenseits reiner VMs — bei geringerer operativer Komplexität durch die Kubernetes-native Architektur."
---
...
<div class="diagram__node diagram__node--brand"><b>Ænix Platform Provider Edition</b><div class="diagram__chips"><span>cozyportal</span><span>Migrations-Tooling</span></div></div>
...
Produktive Referenzen: regionale Hosting-Anbieter betreiben die Ænix Platform Provider Edition; Tier-1-europäische Bank-Deployments unter NDA bis Mitte 2027.
