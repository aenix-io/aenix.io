...
quick_facts:
  ...
  - label: "Multi-tier model"
    value: "Nested Tenant CRD maps to Aenix tenant to MSP tenant to MSP-customer tenant, with a branded Cozystack Dashboard and WHMCS-integrated billing."
  - label: "Productized offering"
    value: "Pairs with the Aenix Public Cloud Platform; support tiers start at Basic $1,250/mo (10 nodes), with up to 40% partner margin on resold engagements."
faq:
  ...
  - q: "How does white-label work with Cozystack?"
    a: "The Cozystack Dashboard self-service console is customizable — colors, logo, and domain — so customers see the MSP's brand. The nested Tenant CRD provides a multi-tier hierarchy from the Aenix tenant down to each MSP-customer tenant."
...
> **Pairs with:** **[Ænix Public Cloud Platform](/products/public-cloud-platform/)** — fully white-labelable Cozystack Dashboard, multi-tier reseller model, WHMCS-integrated billing, from $1,250/month support tier. See **[Partner Program](/partners/)** for up to 40% margin on resold engagements.
