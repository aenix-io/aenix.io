...
hero_chips:
  ...
  - "На русском языке"
hero_primary: { text: "Забронировать место", href: "#register" }
...
quick_facts:
  - label: "Когда"
    value: "Среда, 9 сентября 2026, 14:00–17:00 по Астане (UTC+5)"
  - label: "Формат"
...
<div class="ws-wrap ws-cta-center"><a class="cta-primary cta-accent" href="#register">Забронировать место</a></div>
</section>
...
<div class="ws-cta-center"><a class="cta-primary cta-accent" href="#register">Забронировать место</a></div>
</div>
</section>
...
<p class="ws-register__note">Ссылку на подключение пришлём на почту после регистрации — вместе с напоминаниями за день и за час до начала.</p>
</div>
</section>
