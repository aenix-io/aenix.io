...
faq:
  ...
  - q: "У нас Oracle RAC / SAP / лицензионный Windows. Это переедет?"
    a: "Возможно, нет — и мы скажем это честно. Лицензирование ISV (Oracle считает все ядра кластера на неодобренном гипервизоре; у SAP и Microsoft — списки сертифицированных платформ) — одно из реальных ограничений, разбираемых в блоке честных ограничений. Приходите со своей самой страшной VM и получите прямой вердикт."
  ...
  - q: "Можете прислать официальное письмо-приглашение для работодателя?"
    a: "Да — по запросу после регистрации пришлём официальное письмо-приглашение на компанию: обосновать полдня вне офиса станет делом одного письма."
---
